...
const [fp, sp, ...all] = products;
console.log({ fp, sp, all });

//task28

const count = (...p) => p.length;
console.log(count(products[0], products[1], products[2]));

//task29
const overrideProduct = (p, o) => ({ ...p, ...o });
console.log(overrideProduct(products[0], { price: 92000, stock: 15 }));

//task30
const task30 = [...products.slice(0, 3), ...products.slice(7, 10)];
console.log(task30);